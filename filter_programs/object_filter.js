...
// Filter orders where one of the items is below a certain price 
// [{order: {items: [{product: "Shirt", price: 25}, {product: "Shoes", price: 50}]}}] => [{order: {items: [{product: "Shirt", price: 25}, {product: "Shoes", price: 50}]}}]
const filterOrdersByItemPrice = function (orders, maxPrice) {
};

// Filter events where at least one speaker is a particular person 
// [{event: {name: "Tech Talk", speakers: [{name: "John"}, {name: "Alice"}]}}] => [{event: {name: "Tech Talk", speakers: [{name: "John"}, {name: "Alice"}]}}]
...
// Filter users who have a certain number of followers and have posted in
//  the last 30 days 
// [{user: {name: "Tom", followers: 1000, lastPostDate: "2024-11-10"}}] 
// => [{user: {name: "Tom", followers: 1000, lastPostDate: "2024-11-10"}}]
